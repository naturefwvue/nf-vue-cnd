...
export default {
  ...
  setup () {
    ...
    console.log('retObject2', retObject2)
    console.log('retObject2-contacts', retObject2.contacts)
    // 浅层响应
    console.log('shallowRet1', shallowRet1)
    console.log('shallowRet2', shallowRet2)
    console.log('shallowRet2-contacts', shallowRet2.contacts)
    // 数组
